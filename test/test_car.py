...
class TestCalliope(unittest.TestCase):
    def test_battery_should_be_serviced(self):
        ...
        car = CarFactory.calliope(today, last_service_date, current_mileage, last_service_mileage)
...
class TestRorschach(unittest.TestCase):
    def test_battery_should_be_serviced(self):
        ...
        car = CarFactory.rorschach(last_service_date, current_mileage, last_service_mileage)
        self.assertTrue(car.needs_service())
    ...
    def test_engine_should_not_be_serviced(self):
        ...
        car = CarFactory.rorschach(today, last_service_date, current_mileage, last_service_mileage)
        self.assertFalse(car.needs_service())
...
class TestThovex(unittest.TestCase):
    def test_battery_should_be_serviced(self):
        ...
        car = CarFactory.thovex(today, last_service_date, current_mileage, last_service_mileage)
        self.assertTrue(car.needs_service())
